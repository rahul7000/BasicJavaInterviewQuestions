...
public class RunThreadsInOrderUsingSemaphore {
	...
	static class Foo {
		...
		/*
		 * If funcA is called, a new thread will be created and the corresponding action
		 * will be executed.
		 */
		void funcA() {
			Runnable action = () -> {
		...
		/*
		 * If funcB is called, a new thread will be created and the corresponding action
		 * will be executed.
		 */
		...
		/*
		 * If funcC is called, a new thread will be created and the corresponding action
		 * will be executed.
		 */
